...
export default function ChatPage() {
  ...
  // Use project messages if a project is selected, otherwise use current session messages
  const displayMessages = selectedProject ? projectMessages : (currentSession?.messages || []);
